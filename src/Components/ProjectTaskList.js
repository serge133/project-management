        ...
        if(addTaskPopup.show && !tagsPopup){
            return (
                <Popup close={toggleAddTaskPopup}>
                    ...
                    <div className="selected_tag" style={{border: `3px solid ${addTaskPopup.tag.color}`}} onClick={toggleTagsPopup}>
        ...
        if(editTaskPopup.show && !tagsPopup){
            return (
                <Popup close={closeEditPopup}>
                    ...
                    <div className="selected_tag" style={{border: `3px solid ${editTaskPopup.task.tag.color}`}} onClick={toggleTagsPopup}>
