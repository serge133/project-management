...
import { Wrapper, ControlPanel, Tasks } from "../Components/ProjectTaskList";
...
const TaskList = props => {
  ...
  return (
    <Wrapper>
      ...
      {project.editMode ? (
        <Tasks tasks={project.tasks} taskActions={taskActions} />
      ) : (
        <Sortable setList={saveSortableOrder}>{project.tasks}</Sortable>
      )}
    </Wrapper>
  );
};
